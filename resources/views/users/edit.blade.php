                            ...
                            <form method="POST" action="{{route('users.update',['user'=>$user->id])}}">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input name="member_no" type="text" class="form-control" placeholder="Member Number" value="{{$user->member_no}}" />
                                                </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input name="contact" type="text" class="form-control mobile-phone-number" placeholder="Ex: +00 (000) 000-00-00" value="{{$user->contact}}">
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="demo-checkbox">
                                                    ...
                                                    @if ($user->is_member === 1)
                                                      <input name="is_member" value="1" type="checkbox" id="basic_checkbox_1" class="filled-in" checked/>
                                                    @else
                                            ...
                                            <div class="col-md-3">
                                                <div class="demo-checkbox">
                                                    ...
                                                    @if ($user->is_staff === 1)
                                                      <input name="is_staff" value="1" type="checkbox" id="basic_checkbox_2" class="filled-in" checked/>
                                                    @else
